...
import { IColumn, CheckboxVisibility, IDetailsListProps } from 'office-ui-fabric-react/lib/DetailsList';
...
import { CollapseAllVisibility } from 'office-ui-fabric-react/lib/DetailsList';
import { IBaseProps, IRefObject, IStyleFunctionOrObject, IRenderFunction, EventGroup } from 'office-ui-fabric-react/lib/Utilities';
import { IDetailsRowCheckProps, IDetailsCheckboxProps } from 'office-ui-fabric-react/lib/DetailsList';
...
export interface IDetailsRowBaseProps extends Pick<IDetailsListProps, 'onRenderItemColumn'>, IBaseProps<IDetailsRow>, IDetailsItemProps {
  ...
  selectionEventGroup?: EventGroup;
}
