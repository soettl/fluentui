...
import * as Styles from './MarqueeSelection.scss';
...
export class MarqueeSelection extends BaseComponent<IMarqueeSelectionProps, IMarqueeSelectionState> {
  ...
  public render(): JSX.Element {
    const { rootProps, children, className } = this.props;
    const { dragRect } = this.state;

    return (
      <div {...rootProps} className={css(Styles.root, className)} ref={this._root}>
        {children}
        {dragRect && <div className={Styles.dragMask} />}
        {dragRect && (
          // tslint:disable-next-line:jsx-ban-props
          <div className={Styles.box} style={dragRect}>
